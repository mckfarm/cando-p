...
start_time <- "2022-01-19 08:20:00"
end_time <- "2022-01-19 14:40:00"
file_path <- "C:/Users/mckyf/Northwestern University/Wells Research Group - CANDO+P and N2O/CANDO+P Reactor/Operation and Logs"

sheet_name <- "22.01.19"

in_hach <- "./Sensor logs/Hach/hach_dl_220120.csv"
in_n2o <- "./Sensor logs/Unisense/n2o_220120.xlsx"
...
ggplot() +
  ...
  geom_point(data=cycle_nitrogen,mapping=aes(hour,NO3_mgNL),color="#2BA84A",shape=6) +
  xlab("Hours") +
