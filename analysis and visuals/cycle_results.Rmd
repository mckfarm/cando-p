...
ggplot(data=subset(cycle_long, parameter %in% params_no_no3), mapping=aes(time_diff,value)) + 
  ...
  theme_classic() + 
  scale_color_manual(values=colors,labels=c("DO (mgO2/L)","NO2 (mgN/L)","OP (mgP/L)")) + 
  scale_shape_manual(values=c(19,17,15),labels=c("DO (mgO2/L)","NO2 (mgN/L)","OP (mgP/L)"))
